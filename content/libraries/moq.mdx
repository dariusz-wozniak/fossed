...
**[TUnit.Mocks](https://tunit.dev/docs/writing-tests/mocking/)**: A modern API for performing Mocks, based on Roslyn source code generators that guarantee execution speeds up to 10 times faster. Independent of the TUnit testing framework. It also includes a mock generator for [HttpClient](https://tunit.dev/docs/writing-tests/mocking/http).
       * [Setup & Stubbing](https://tunit.dev/docs/writing-tests/mocking/setup)
